...
public class MOEAD_DTLZ1Test {
    public static void main(String[] args) {
        ...
        AbstractMOOPAlgorithm moead = new MOEAD(population, problem, closestVectors, parameterH, mutation, crossover, maxGen);
